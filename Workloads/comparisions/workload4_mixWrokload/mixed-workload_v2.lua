...
local read_home_timeline_ratio = tonumber(os.getenv("READ_HOME_TIMELINE_RATIO")) or 0.60
local read_user_timeline_ratio = tonumber(os.getenv("READ_USER_TIMELINE_RATIO")) or 0.30
local compose_post_ratio = tonumber(os.getenv("COMPOSE_POST_RATIO")) or 0.10
